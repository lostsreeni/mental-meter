...
MindCheck is a privacy-first, fully offline-capable mental health tracking application. It is designed to provide users with validated psychological instruments (such as PHQ-2, GAD-2, PHQ-9, GAD-7, and WHO-5) without compromising their data privacy.
...
MindCheck is deployed as a fully static export. To test the production build locally:
